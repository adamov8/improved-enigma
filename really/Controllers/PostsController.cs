...
namespace really.Controllers
{
    ...
    {
        private readonly reallyDbContext _context;

        public PostsController(reallyDbContext context)
        {
            _context = context;
        }
        ...
        {
            var reallyDbContext = _context.Posts.Include(p => p.Blog);
            return View(await reallyDbContext.ToListAsync());
        }
